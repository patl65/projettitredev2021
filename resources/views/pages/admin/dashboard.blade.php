                            ...
                            <div class="card text-white bg-primary">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart1" height="70"
                                        style="display: block; width: 500px; height: 70px;" width="500"></canvas>
                                    <div id="card-chart1-tooltip" class="c-chartjs-tooltip top bottom"
                                        style="opacity: 0; left: 82.1123px; top: 93.2444px;">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-info">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart2" height="70" width="500"
                                        style="display: block; width: 500px; height: 70px;"></canvas>
                                    <div id="card-chart2-tooltip" class="c-chartjs-tooltip top bottom"
                                        style="opacity: 0; left: 111.89px; top: 116.979px;">
                                        <div class="c-tooltip-header">
                                        ...
                                        <div class="c-tooltip-body">
                                            <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color"
                                                    ...
                                                    class="c-tooltip-body-item-label">My First dataset</span><span
                                                    class="c-tooltip-body-item-value">17</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-warning">
                                ...
                                <div class="c-chart-wrapper mt-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart3" height="70" width="532"
                                        style="display: block; width: 532px; height: 70px;"></canvas>
                                    <div id="card-chart3-tooltip" class="c-chartjs-tooltip top"
                                        style="opacity: 0; left: 111px; top: 126.5px;">
                                        <div class="c-tooltip-header">
                                            <div class="c-tooltip-header-item">April</div>
                                        </div>
                                        <div class="c-tooltip-body">
                                            <div class="c-tooltip-body-item"><span class="c-tooltip-body-item-color"
                                                    ...
                                                    class="c-tooltip-body-item-label">My First dataset</span><span
                                                    class="c-tooltip-body-item-value">45</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-danger">
                                ...
                                <div class="c-chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart4" height="70" width="500"
                                        style="display: block; width: 500px; height: 70px;"></canvas>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                                ...
                                <canvas class="chart chartjs-render-monitor" id="main-chart" height="300" width="2185"
                                    style="display: block; width: 2185px; height: 300px;"></canvas>
                                <div id="main-chart-tooltip" class="c-chartjs-tooltip center top"
                                    style="opacity: 0; left: 823.484px; top: 164.93px;">
                                    <div class="c-tooltip-header">
